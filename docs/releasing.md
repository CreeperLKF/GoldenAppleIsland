...
Pushing a `v*` tag triggers `.github/workflows/release.yml`, which on a Windows runner builds the MSI and NSIS installers plus the WSL tarball and attaches them to a new GitHub Release.
