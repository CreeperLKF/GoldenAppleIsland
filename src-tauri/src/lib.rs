...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::use_default_agent_workspace,
            commands::reset_default_agent_workspace,
            commands::reset_agent_session,
            commands::get_agent_session_snapshot,
            commands::get_external_config,
            commands::set_external_config,
            commands::test_external_endpoint,
            commands::take_over_delegated,
            commands::list_delegated,
            commands::set_hotkey,
            commands::audit_list,
